...
public class MessageTest extends TestCase {
	...
	public void testCreateMessage() {
		...
		//A good build.
		try{
			mess = Message.createMessage(new Ipv4("0.0.0.0"), 0, 5, MessageSR.SR_TIME_NAME, params);
		...
		mess = Message.createMessage(new Ipv4("0.0.0.0"), 0, 5, MessageSR.SR_TIME_NAME, "1");
		assertTrue(mess == null);
		
		//Bad ip
		mess = Message.createMessage(null, 5, 0, MessageSR.SR_TIME_NAME, "1");
		assertTrue(mess == null);
		
		//Bad port.
		mess = Message.createMessage(new Ipv4("0.0.0.0"), -2, 0, MessageSR.SR_TIME_NAME, params);
		assertTrue(mess == null);
		
		//Bad id game.
		mess = Message.createMessage(new Ipv4("0.0.0.0"), -2, -1, MessageSR.SR_TIME_NAME, params);
		assertTrue(mess == null);
		mess = Message.createMessage(new Ipv4("0.0.0.0"), -2, null, MessageSR.SR_TIME_NAME, params);
		assertTrue(mess == null);
	...
	public void testGetIpv4() {
		...
		//A good build.
		try{
			mess = Message.createMessage(new Ipv4("0.0.0.0"), 5, 0, MessageSR.SR_TIME_NAME, params);
		}catch(IllegalArgumentException e){
			assertTrue(false);
		}
		assertTrue(mess != null);

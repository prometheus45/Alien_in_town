...
public class MessageSG {
	...
	public static String addAvatar(Ipv4 ip, Integer port, Integer id_game, String a_n, String a_p, Type type, Condition c){
	...
	public static String removeAvatar(Ipv4 ip, Integer port, Integer id_game, String p){

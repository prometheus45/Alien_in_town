...
public class MessageSGTest extends TestCase {
	...
	public void testChat() {
		String message = MessageSG.chat(new Ipv4("0.0.0.0"), 1, 0,"message");	
		
		assertNotNull(message);
		assertNull(MessageSG.chat(null, 1, 0,"message"));
		assertNull(MessageSG.chat(null, -1, 0,"message"));
		assertNull(MessageSG.chat(new Ipv4("0.0.0.0"), null, 0,"message"));
		assertNull(MessageSG.chat(new Ipv4("0.0.0.0"), 1, 0,null));
	...
	public void testAddAvatar() {
		String message = MessageSG.addAvatar(new Ipv4("0.0.0.0"), 1, 0,"name", "name", Type.DOCTOR, Condition.ALIVE);
		assertNotNull(message);
	...
	public void testRemoveAvatar() {
		String message = MessageSG.removeAvatar(new Ipv4("0.0.0.0"), 1, 0,"name");	
		
		assertNotNull(message);
		assertNull(MessageSG.chat(null, 1, 0,"name"));
		assertNull(MessageSG.chat(null, -1, 0,"name"));
		assertNull(MessageSG.chat(new Ipv4("0.0.0.0"), null, 0,"name"));
		assertNull(MessageSG.chat(new Ipv4("0.0.0.0"), 1, 0,null));
